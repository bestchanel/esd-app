...
const fetchUsers = async () => {
  try {
    const response = await axios.get('https://esd-app-strapi-dq8t.onrender.com/api/users?populate=branches');
...
const saveUserData = async () => {
  ...
  try {
    await axios.post("https://esd-app-strapi-dq8t.onrender.com/api/auth/local/register", payload);
    Swal.fire({
      icon: "success",

...
// สถานะของ User_Type
export const User_Type = ref(localStorage.getItem("User_Type") || "Token not found");
...
const allMenuItems = [
  ...
  },
  {
    ...
    icon: "fluent-mdl2:edit", // เปลี่ยนจาก insert-signature-line เป็น edit เพื่อแสดงการบันทึก/แก้ไขข้อมูล
    link: "insertvalueuser",
    allowedRoles: ["Manager", "Employee"],
  },
  {
    title: "จัดการค่าความต้านทาน",
    icon: "fluent-mdl2:settings", // ใช้ settings สำหรับการจัดการค่าความต้านทาน
    link: "insertvalue",
    allowedRoles: ["Manager"],
  },
  {
    title: "จัดการข้อมูลผู้ใช้งาน",
    icon: "mingcute:user-4-fill", // ใช้ user-settings-fill สำหรับการจัดการข้อมูลผู้ใช้งาน
    link: "manageuser",
    allowedRoles: ["Manager"],
  },
];

// กำหนดเมนูเป็น reactive
export const menuItems = computed(() =>
  allMenuItems.filter(
    (item) => !item.allowedRoles || item.allowedRoles.includes(User_Type.value)
  )
);
